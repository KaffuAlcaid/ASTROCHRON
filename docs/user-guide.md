...
每颗卫星下方显示从所选时刻起未来 24 h 内的下一次过境、峰值高度角和光学条件，表头可选择“清单顺序”或“下一次过境”排序
...
滚轮或加减按钮可缩放地图，拖动可平移，“全球视图”恢复完整世界地图

点击“跟随卫星”或按 F，将地图设为 9× 并持续跟随当前目标，跟随期间可继续缩放，再次点击或按 F 恢复原视图
...
点击过境表旁的“导出观测计划”或按 Ctrl+E，查看当前目标从所选时刻起未来 12 h 的过境，选择“导出 CSV”或“导出 ICS”保存

CSV 可用表格软件打开，ICS 可导入日历；事件时间以 UTC 保存，说明包含观测地点时区、本地时间、最高点与轨道历元
...
点击固定按钮可长期保留当前快照；在设置中点击“查看待清理记录”，可先固定重要资料，再启用自动清理，每组在线资料可保留最近 5 或 10 份，固定记录与本地导入长期保留
...
设置中的“获取观测天气预报”控制天气查询，“绘图刷新频率”可在 1–60 Hz 之间选择，“轨道计算频率”控制位置与观测数值的更新，取值上限为绘图刷新频率，两项默认均为 1 Hz

顶部月亮图标切换深色和浅色界面

在设置中点击“检查更新”可查询 GitHub 发布版本，“接收预发布版本”控制是否包含 preview 等版本；发现更新后可查看说明，点击“打开发布页”选择下载文件
